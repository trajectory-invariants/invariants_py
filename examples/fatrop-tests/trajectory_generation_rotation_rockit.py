...
boundary_constraints = {"orientation": {"initial": R_obj_start, "final": R_obj_end}, "moving-frame": {"rotational": {"initial": R_r_init, "final": R_r_init}}}
...
while current_progress <= 1.0:
    ...
    boundary_constraints = {"orientation": {"initial": calculate_trajectory[current_index], "final": R_obj_end}, "moving-frame": {"rotational": {"initial": movingframes[current_index], "final": movingframes[-1]}}}

    initial_values = {"invariants": {"rotational": model_invariants}, "trajectory": {"orientation": calculate_trajectory}, "moving-frame": {"rotational": movingframes}}
