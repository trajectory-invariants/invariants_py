...
for k in range(len(targets)):
    ...
    tot_time[k] = end_time-start_time
...
print(str(sum(tot_time)/len(targets)) + "[s]") # Better ways of measuring calculation time?
print('')
print("MAXIMUM time to generate new trajectory: ")
print(str(max(tot_time)) + "[s]")
